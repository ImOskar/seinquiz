  ...
  return (
    <div className="container">
      ...
      {newGame ? (
        ...
        <ResultPanel clickHandler={() => handleRestartClick()} 
          score={score} gif={gif} questions={questions.length}></ResultPanel> 
			  ) : (
        <QuestionPanel clickHandler={() => handleAnswerOptionClick} 
          currentQuestion={currentQuestion} questions={questions}></QuestionPanel>
			  )}
