const QUIZ_DATA = [
  {
    question: 'Whose repair shop does Jerry tell his parents he took the watch to?',
    answers: [
      'Doug Colt',
      'Mickey Abbot',
      'Jimmy Sherman',
  ...
  {
    question: 'What is the name of Elaine\'s coworker to whom Jerry makes the panty remark in \'The Cheever Letters?',
    answers: [
      'Lisa',
      'Sandra',
      'Wendy',
  ...
  {
    question: 'Mr. Steinbrenner trades George to what company in \'The Muffin Tops?\'',
    answers: [
  ...
  {
    question: 'Elaine gets the attention of George\'s boss in \'The Revenge\' by telling him she\'s going where?',
    answers: [
  ...
  {
    question: 'What reason do Newman and Kramer give for reversing their peepholes?',
    answers: [
  ...
  {
    question: 'What kind of car was George originally going to buy before deciding to buy Jon Voight\'s LeBaron?',
    answers: [
      'Honda',
      'Volvo',
      'Saab',
  ...
  {
    question: 'What is the name of Jerry\'s college friend who manages Kenny Rogers Roasters?',
    answers: [
      'Drake',
      'Jack',
      'Seth',
  ...
  {
    question: 'What does Jerry say he would rather do than have dinner with Bania?',
    answers: [
      'Drink bleach',
      'Make his own suit',
      'Kiss George',
  ...
  {
    question: 'According to George in \'The Beard,\' nobody asks a barber for what kind of haircut?',
    answers: [
      'The Drew Boggs',
      'The Larry Fine',
      'The Wayne Wurth',
  ...
  {
    question: 'What score does Elaine earn on the second IQ test she takes in place of George?',
    answers: [
      '128',
      '130',
      '115',
  ...
  {
    question: 'According to Newman, the air in Hawaii is so dewy-sweet that you don\'t even have to do what?',
    answers: [
      'Shower',
      'Drink water',
      'Wear a shirt',
  ...
  {
    question: 'How much did Kramer get for being greeted with \'Hey\' instead of \'Hello?',
    answers: [
      '$100',
      '$50',
      '$10',
  ...
  {
    question: 'What does George spot from across Jerry\'s apartment while squinting?',
    answers: [
      'A squirrel',
      'A dime',
      'A spider',
  ...
  {
    question: 'What song is Mr. Steinbrenner singing in George\'s office while George hides under the desk?',
    answers: [
      'Alfie',
      'Emotion',
      'Midnight Lady',
  ...
  {
    question: 'How does the doctor on duty when Susan died describe George\'s reaction upon hearing the news of her death?',
    answers: [
      'Mild relief',
  ...
  {
    question: 'What is the name of the pizza joint where George gets the Frogger?',
    answers: [
      'Mario\'s',
      'Paisano\'s',
      'Papi\'s',
  ...
  {
    question: 'Who is the baseball player that actually spit on Kramer and Newman?',
    answers: [
      'McDowell',
      'Hundley',
      'Olerud',
  ...
  {
    question: 'Where do the tiny surgical instruments for the squirrel operation come from?',
    answers: [
      'Guadalupe',
      'El Dorado',
      'De Soto',
  ...
  {
    question: 'Which state do Kramer and Newman plan to drive to so they can cash in the empty bottles?',
    answers: [
      'Ohio',
      'Pennsylvania',
      'Maine',
  ...
  {
    question: 'Jerry gives Elaine $182 in cash for her birthday. What does George give her?',
    answers: [
      'A bench',
      '$183',
      'Theater tickets',
  ...
  {
    question: 'What part of Kramer\'s body do the Calvin Klein executives describe as \'sublime\'?',
    answers: [
      'His buttocks',
      'His torso',
      'His face',
  ...
  {
    question: 'Kramer is forced to fire this actress from \'Scarsdale Surprise\' in order to keep his stolen Tony Award.',
    answers: [
      'Marisa Tomei',
      'Bette Midler',
      'Barbara Hershey',
  ...
  {
    question: 'This animal expert brings a hawk to the Merv Griffin Show set in Kramer\'s apartment.',
    answers: [
      'Jim Fowler',
      'Brad Clover',
      'Bob Flowers',
  ...
  {
    question: 'Kramer tries to give this actor a script after seeing him in a cafe in Los Angeles.',
    answers: [
      'George Wendt',
      'Candice Bergen',
      'Corbin Bernsen',
  ...
  {
    question: 'Which singer can\'t walk down the street in South America because of his cult following?',
    answers: [
      'Andy Russell',
      'Lucho Gatica',
      'Sergio Mendes',
  ...
  {
    question: 'What is the name of the electrician who helps George take the Frogger machine?',
    answers: [
      'Schlomo',
      'The fixer',
      'Snoopy',
  ...
  {
    question: 'What is the name of Kramer\'s girlfriend with the long nails who scratches his back?',
    answers: [
      'Olive',
      'Cheryl',
      'Wendy',
  ...
  {
    question: '"I find _____ to be the most sensual of all the salted cured meats"',
    answers: [
      'Pastrami',
      'Salami',
      'Corned beef',
  ...
  {
    question: 'Kramer gets a job on the TV show \'Murphy Brown\' as her secretary. What is his name on the show?',
    answers: [
      'Brian Green',
      'Frank Gilmore',
      'Steven Snell',
  ...
  {
    question: 'What are the first names Jerry and George make up for Murphy and O\'Brien?',
    answers: [
      'Frank and Dylan',
      'Virgil and John',
      'Ted and Sean',
  ...
  {
    question: 'What does Ping say his cousin Cheryl Fong\'s nickname is in court',
    answers: [
      'The Terminator',
      'Briefs Bandit',
      'Ping the merciless',
  ...
  {
    question: 'Who does Kramer promise will hit 2 home runs to a little sick boy?',
    answers: [
      'Derek Jeter',
      'Wade Boggs',
      'Brad Clontz',
  ...
  {
    question: 'What does Kramer feed his horse while he\'s driving a horse drawn carriage?',
    answers: [
      'Baked beans',
      'SpaghettiOs',
      'Chili',
  ...
  {
    question: 'Which of the following is not a euphemism for "abstinence from masturbation?"',
    answers: [
      'Queen of the castle',
      'Master of my domain',
      'Lord of the manor',
  ...
  {
    question: 'George describes his bachelor paradise as eating a block of cheese the size of what?',
    answers: [
      'A spin wheel',
      'A car battery',
      'A brick',
  ...
  {
    question: 'When Mr. Wilhelm joins the carpet cleaning cult, what does he change his name to?',
    answers: [
      'Tania',
      'Sunshine',
      'Lucian',
  ...
  {
    question: 'What is the name of the horse that pulls Kramer\'s horse drawn carriage?',
    answers: [
      'Scout',
      'Pie-O-My',
      'Rusty',
  ...
  {
    question: 'When George thinks he is having a heart attack, what is actually happening?',
    answers: [
  ...
  {
    question: 'What is the name of Elaine\'s boyfriend who Jerry deems a "Mimbo?"',
    answers: [
      'Brett',
      'Joey',
      'Tony',
  ...
  {
    question: 'What does George\'s zookeeper girlfriend say after he first tells her he loves her?',
    answers: [
      'Thank you',
      'I\'m hungry',
      'That\'s nice',
  ...
  {
    question: 'What is the obnoxious pet name Jerry uses for his girlfriend in "The Soup Nazi?"',
    answers: [
      'Snookie',
      'Schmoops',
      'Schmoopie',
  ...
  {
    question: 'Which of the following is not a reason why Jerry breaks up with a girlfriend?',
    answers: [
  ...
  {
    question: 'How much do the John F. Kennedy golf clubs start at in the auction?',
    answers: [
      '$2,000',
      '$4,000',
      '$10,000',
  ...
  {
    question: 'Who moves cars from one side of the street to the other, so that people don\'t get parking tickets?',
    answers: [
      'Sid',
      'Gus',
      'Bob',
  ...
  {
    question: 'What name does Joel Rifkin think is associated with a guy who buys irregular underwear?',
    answers: [
      'Remy',
      'Ned',
      'Silas',
  ...
  {
    question: 'What move does David Puddy supposedly steal from George in "The Fusilli Jerry"?',
    answers: [
      'The knuckle',
      'The swirl',
  ...
  {
    question: 'What country is Mr. Pitt visiting while Elaine is watching over his apartment?',
    answers: [
      'Ireland',
      'England',
      'Scotland',
  ...
  {
    question: 'How much money does Kramer say Elaine should put in to enter into "The Contest"?',
    answers: [
      '$100',
      '$500',
      '$1,000',
  ...
  {
    question: 'Jerry dated a Miss America contestant. Which state was she from?',
    answers: [
      'Vermont',
      'Delaware',
      'New Hampshire',
  ...
  {
    question: 'What was the name of the bookstore where Jerry caught his Uncle Leo shoplifting?',
    answers: [
      'Brentano\'s',
      'Borders',
      'The Strand',
  ...
  {
    question: 'What brand of tip calculators did Kramer and Morty give out to residents of Del Boca Vista in return for their votes?',
    answers: [
      'Computron',
      'Willard',
      'Wizard',
  ...
  {
    question: 'In the episode "The Old Man", Kramer and Newman attempt to sell used records at what establishment?',
    answers: [
      'Putumayo',
  ...
  {
    question: 'Kramer ruined a washing machine by filling it with concrete mix. How much did Kramer estimate the damage to be?',
    answers: [
      '$800',
      '$1,000',
      '$1,200',
  ...
  {
    question: 'Elaine\'s rock climbing boyfriend Tony dislikes which kind of sandwiches?',
    answers: [
      'Peanut butter',
      'Egg salad',
      'Tuna salad',
  ...
  {
    question: 'What score did Elaine originally get on the IQ Test she took for George?',
    answers: [
      '75',
      '81',
      '85',
